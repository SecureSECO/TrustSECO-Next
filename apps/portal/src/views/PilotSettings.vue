...
const sources = [{id:'github',label:'GitHub API token',help:'Used by GitHub collectors for authenticated API access. Without it, public requests have lower rate limits.'},{id:'libraries',label:'Libraries.io API key',help:'Used for contributor counts, dependencies, dependents, release history and SourceRank. Requires funded Libraries.io collection rounds.'}];
