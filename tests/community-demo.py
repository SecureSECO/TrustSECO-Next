...
def main():
    ...
    for i in range(1,6):
        ...
        send('governor','open',round=rid,package='demo/stars-case-'+str(i),metric='github_stars',source='GitHub fixture',method='prototype-v1',duration=40)
    ...
    send('governor','open',round='suspended-submission',package='demo/suspended-contributor',metric='github_stars',source='GitHub fixture',method='prototype-v1',duration=10)
