...
"$docker_bin" run --rm --platform linux/amd64 -v trustseco-pilot_node4:/source:ro -v "$backup_dir:/backup" trustseco-pilot-ledger sh -c 'umask 077; tar --exclude="*/tmp/sockets" -czf /backup/ledger.tar.gz -C /source .'
